...
import CollapsedTerminalRail from '@/views/project/tabs/terminal/components/CollapsedTerminalRail.vue';
import TerminalPane from '@/views/project/components/terminal-pane/TerminalPane.vue';
