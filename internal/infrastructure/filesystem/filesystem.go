...
func (r FileSystem) copySymlink(source string, destination string) error {
...
func (r FileSystem) copyDirectory(source string, destination string) error {
...
func (r FileSystem) copyFile(source string, destination string, mode fs.FileMode) error {
	if err := os.MkdirAll(filepath.Dir(destination), 0o755); err != nil {
		return err
	}
