...
func TestOpenAPISpecIncludesOperationIDs(t *testing.T) {
	...
	expectedOperationIDs := map[string]string{
		...
		"GET /api/v1/review-snapshots/{snapshotId}/annotations":                   "listReviewAnnotations",
		"POST /api/v1/review-snapshots/{snapshotId}/annotations":                  "createReviewAnnotation",
		"GET /api/v1/review-snapshots/{snapshotId}/annotations/events":            "subscribeReviewAnnotationEvents",
		"DELETE /api/v1/review-snapshots/{snapshotId}/annotations/{annotationId}": "deleteReviewAnnotation",
		...
		"GET /api/v1/workspaces/{workspaceId}/review-snapshots":                   "listWorkspaceReviewSnapshots",
